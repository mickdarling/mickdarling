...
`TypeScript` `Python` `Node.js` `Model Context Protocol (MCP)` `LLM Orchestration` `Agent Architecture` `Zulip` `GitHub Actions`
...
- Core MCP server: 28+ stars, TypeScript, published on npm
